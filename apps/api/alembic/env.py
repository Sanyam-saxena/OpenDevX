...
Reads the database URL from OpenDevX application settings to avoid
duplicating connection strings. Supports both offline (SQL generation) and
online (live database) migration modes.
"""
