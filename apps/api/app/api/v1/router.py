...
from app.api.v1.ai_rca import router as ai_rca_router
...
from app.api.v1.k8s import router as k8s_router
...
router.include_router(pipeline_router, prefix="/projects", tags=["pipeline"])
router.include_router(k8s_router, prefix="/projects", tags=["k8s"])
router.include_router(finops_router, prefix="/projects", tags=["finops"])
router.include_router(ai_rca_router, prefix="/projects", tags=["ai_rca"])
